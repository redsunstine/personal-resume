            ...
            <div className="basic-info">
                ...
                <Row>
                    ...
                    <Col md={3} className="center-mobile-text">
                        ...
                        <a style={{ color: "#007bb5" }} target="_blank" href="https://www.linkedin.com/in/denny-kays-3a79a3a4/">
                        ...
                        <a style={{ color: "red" }} target="_blank" href="mailto:denny.kays@dennisdkaysjr.com">
                            <span className="fa-stack fa-lg">
                                <i className="fas fa-circle fa-stack-2x"></i>
